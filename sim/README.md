...
1. Clone the repository using Git. Execute this in a terminal: `git clone https://github.com/gavinskycastle/Threepeater_LED.git`
2. Cd into Threepeater_LED/sim. `cd Threepeater_LED/sim`
...
8. Run a local web server and open the Threepeater_LED.html

## Building (Linux/macOS)
 
1. Clone the repository using `git clone https://github.com/gavinskycastle/Threepeater_LED.git`
2. Move to the Threepeater_LED/sim directory `cd Threepeater_LED/sim`
...
8. Make the binary executable `chmod +x Threepeater_LED`
9. Run the binary with `./Threepeater_LED`
...
7. Run Threepeater_LED.exe! You have just compiled Threepeater_LED for Windows using MinGW.
...
7. Go into Debug, your build of Threepeater_LED is there. You have now compiled Threepeater_LED for Windows using MSVC.
